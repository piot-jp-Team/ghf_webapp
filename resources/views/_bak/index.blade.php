...
$("#ex<?php echo $i;?>").slider({});
          ...
          $.get(url, function(response){
			...
			$('#chart<?php echo $i; ?>').html("<div class='col-md-4'>" + titlename + "　" + labelname+"</div><div class='col-md-4'>　現在:"+valcur+"　平均:"+valavg+"　</div><div class='col-md-4'><p style='font-size: 0.8em !important;'>最大:"+valmax+"　最小:"+valmin + "</p></div>");
