...
<?php foreach ($sensors as $value) {
    ...
    ?>
               ...
               <div class="panel panel-default" >
                   <div class="panel-heading statistics" id="chart<?php echo $i; ?>" ><b>Chart<?php echo $i; ?></b></div>
...
$("#ex<?php echo $i;?>").slider({});
          ...
          $.get(url, function(response){
			...
			$('#chart<?php echo $i; ?>').html(titlename + "　" + labelname+"　現在:"+valcur+"　平均:"+valavg+"　<p style='font-size: 0.5em !important;'>最大:"+valmax+"　最小:"+valmin + "</p>");
