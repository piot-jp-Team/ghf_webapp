...
@section('header')
    <div class="page-header clearfix">
        <h1>
            ...
            <a class="btn btn-success pull-right" href="{{ route('projectatusers.create') }}"><i class="glyphicon glyphicon-plus"></i> Create</a>
        </h1>
            ...
            @if($projectatusers->count())
                <table class="table table-condensed table-striped">
                    ...
                    <td>{{$projectatuser->body}}</td>
                                <td class="text-right">
                                    <a class="btn btn-xs btn-primary" href="{{ route('projectatusers.show', $projectatuser->id) }}"><i class="glyphicon glyphicon-eye-open"></i> View</a>
                                    <a class="btn btn-xs btn-warning" href="{{ route('projectatusers.edit', $projectatuser->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
