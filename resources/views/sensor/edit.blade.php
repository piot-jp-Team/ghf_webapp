...
<div class="container">
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Sensor / Edit #{{$sensor->id}}</h1>
    </div>
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('sensor.update', $sensor->id) }}" method="POST">
                ...
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <input type="text"  class="form-control" id="name-field" rows="3" name="name" value="{{ is_null(old("name")) ? $sensor->name : old("name") }}"/>
                       @if($errors->has("name"))
                    ...
                    <input type="text"  class="form-control date-picker" id="address-field" rows="3" name="address" value="{{ is_null(old("address")) ? $sensor->address : old("address") }}"/>
