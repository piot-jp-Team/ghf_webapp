...
<div class="container">
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Sensunit / Create </h1>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('sensunit.store') }}" method="POST">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <input type="text"  class="form-control date-picker" id="channel-field" rows="3" name="channel" value="{{ old("channel") }}"/>
