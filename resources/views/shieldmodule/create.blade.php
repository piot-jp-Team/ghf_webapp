...
<div class="container">
    ...
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Shieldmodule / Create </h1>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('shieldmodule.store') }}" method="POST">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <input type="text"  class="form-control date-picker" id="module_id-field" rows="3" name="module_id" value="{{ old("module_id") }}"/>
